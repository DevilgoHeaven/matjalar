...
| **R-24** | Supabase Free tier 백업 부재 | `.github/workflows/db-backup.yml` 매일 KST 04:00 pg_dump (postgresql-client-17) + 7일 artifact + Discord 알림 | 1회 수동 트리거(`gh workflow run db-backup.yml`) 성공 + artifact 다운로드 확인 |
